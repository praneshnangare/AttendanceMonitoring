...
@
-webkit-keyframes glow {from { box-shadow:005px#fff, 007px#fff, 0010px#e60073,
	0012px#e60073, 0014px#e60073, 0017px#e60073, 0020px#e60073;
	
}

to {
	box-shadow: 0 0 5px #fff, 0 0 7px #ff4da6, 0 0 10px #ff4da6, 0 0 12px
		#ff4da6, 0 0 14px #ff4da6, 0 0 17px #ff4da6, 0 0 20px #ff4da6;
}
}
</style>
</head>
<body>
	<div class="ong">
		<div class="topnav">
			...
			<a class="active"
				href="${pageContext.request.contextPath }/markattendance">Attendance</a>
